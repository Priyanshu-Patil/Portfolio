            ...
            <nav className="flex flex-col md:flex-row items-center gap-6">
              {footerLinks.map((link) => (
                ...
                >
                  ...
                  <span className="font-semibold relative z-5 group-hover:text-black transition-colors duration-300">
                    {link.name}
                  </span>
                  <ArrowUpRightIcon className="size-4 relative z-5 group-hover:text-black transition-colors duration-300  " />
                </a>
              ))}
            </nav>
          </div>
